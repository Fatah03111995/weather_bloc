...
class TextStyles {
  ...
  static TextStyle get ml => normal.copyWith(fontSize: 25);
  static TextStyle get l => normal.copyWith(fontSize: 30);
  static TextStyle get xl => normal.copyWith(fontSize: 40);
